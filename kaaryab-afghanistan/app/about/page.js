...
export default function About() {
  ...
  return (
    <div className="space-y-14 pt-8 md:space-y-16 md:pt-12">
      ...
      <section className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-8 text-white shadow-xl md:p-12">
        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <div className="mb-7 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-white/15 text-2xl ring-1 ring-white/20 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-5">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="group rounded-2xl border border-white/15 bg-white/5 p-6 text-center backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/10"
              >
                <p className="bg-gradient-to-b from-white to-blue-100 bg-clip-text text-3xl font-extrabold tracking-tight text-transparent md:text-4xl">
                  {stat.number}
                </p>
